...
### `musicdl -u [urls]` and `musicdl -f [file_of_urls]` update `./data/music.db` with track info
![ER Diagram](er_diagram.png)

### `musicdl --export` saves all tracks in database to CSV for further processing
